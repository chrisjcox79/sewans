                ...
                <div class="modal-content">
                    <div id="cart-drawer" class="block block-cart">
                            ...
                            <ul class="clearfix">
                                <li class="item clearfix">
                                    <a class="product-image" href="#">
                                        <img src="home/assets/images/product-images/cart-page-img2.jpg" alt="" title="">
                                    </a>
                                ...
                                <li class="item clearfix">
                                    <a class="product-image" href="#">
                                        <img src="home/assets/images/product-images/cart-page-img1.jpg" alt="" title="">
                                    </a>
                                    <div class="product-details">
                                        <a href="#" class="remove"><i class="anm anm-times-sql"
                                                aria-hidden="true"></i></a>
                        ...
                        <div class="minicart-bottom">
                            ...
                            <a href="{{route('cart.index')}}"><button type="button" class="btn btn-secondary cart-btn">View Cart</button></a>
                        </div>
                    </div>
                </div>
            </div>
