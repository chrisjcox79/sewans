...
<div id="page-content">        
    ...
    <div class="breadcrumbs-wrapper">
        <div class="container">
            <div class="breadcrumbs"><a href="index.html" title="Back to the home page">Home</a> <span aria-hidden="true">|</span> <span>Shop Heading With Banners</span></div>
        </div>
    </div>
    <!--End Breadcrumbs-->
    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 item">
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout1.html">Crop Top Green</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 item">
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout1.html">High Neck Ribbed Knit</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 item">
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout1.html">High Waist Jeans</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 item">
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout1.html">Women Shandals</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
