                            ...
                            <div class="product-details-img">
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9.jpg" data-zoom-image="home/assets/images/product-images/product9.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9-1.jpg" data-zoom-image="home/assets/images/product-images/product9-1.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9-2.jpg" data-zoom-image="home/assets/images/product-images/product9-2.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9-3.jpg" data-zoom-image="home/assets/images/product-images/product9-3.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9-4.jpg" data-zoom-image="home/assets/images/product-images/product9-4.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9-5.jpg" data-zoom-image="home/assets/images/product-images/product9-5.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro" src="home/assets/images/product-images/product9-6.jpg" data-zoom-image="home/assets/images/product-images/product9-6.jpg" alt="" />
                                    </div>
                                ...
                                <div class="lightboximages">
                                    <a href="home/assets/images/product-images/product9.jpg" data-size="1000x1280"></a>
                                    <a href="home/assets/images/product-images/product9-1.jpg" data-size="1000x1280"></a>
                                    <a href="home/assets/images/product-images/product9-2.jpg" data-size="1000x1280"></a>
                                    <a href="home/assets/images/product-images/product9-3.jpg" data-size="1000x1280"></a>
                                    <a href="home/assets/images/product-images/product9-4.jpg" data-size="1000x1280"></a>
                                    <a href="home/assets/images/product-images/product9-5.jpg" data-size="1000x1280"></a>
                                    <a href="home/assets/images/product-images/product9-6.jpg" data-size="1000x1280"></a>
                                </div>
            ...
            <div class="productPageSlider">
                <div class="col-12 item">
                    ...
                    <div class="product-details text-center">
                        ...
                        <div class="product-name">
                            <a href="{{route('product.index')}}">Edna Dress</a>
                        </div>
                        <!-- End product name -->
                        <!-- product price -->
                ...
                <div class="col-12 item">
                    ...
                    <div class="product-details text-center">
                        <!-- product name -->
                        <div class="product-name">
                            <a href="{{route('product.index')}}">Elastic Waist Dress</a>
                        </div>
                        <!-- End product name -->
                        <!-- product price -->
                        <div class="product-price">
                ...
                <div class="col-12 item">
                    ...
                    <div class="product-details text-center">
                        <!-- product name -->
                        <div class="product-name">
                            <a href="{{route('product.index')}}">Cape Dress</a>
                        </div>
                        <!-- End product name -->
                        <!-- product price -->
                        <div class="product-price">
                ...
                <div class="col-12 item">
                    ...
                    <div class="product-details text-center">
                        <!-- product name -->
                        <div class="product-name">
                            <a href="{{route('product.index')}}">Paper Dress</a>
                        </div>
                        <!-- End product name -->
                        <!-- product price -->
                        <div class="product-price">
                ...
                <div class="col-12 item">
                    ...
                    <div class="product-details text-center">
                        <!-- product name -->
                        <div class="product-name">
                            <a href="{{route('product.index')}}">Zipper Jacket</a>
                        </div>
                        <!-- End product name -->
                        <!-- product price -->
                        <div class="product-price">
