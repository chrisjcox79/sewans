...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">回收站列表</li>
    </ol>
</nav>
                ...
                <div class="table-responsive pt-3">
                    <table class="table table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <td class="">
                                <a href="javascript:void(0)" class="badge badge-light restore-product" data-id="{{ $v->id }}" data-url="{{route( 'recycle.restore',$v)}}"
                                   data-name="{{ $v->product_name }}">
                                    <i class="btn-icon-prepend" data-feather="check-square"></i>
                                   还原
                                </a>
                                <a href="javascript:void(0)" class="badge badge-secondary delete-product" data-id="{{ $v->id }}" data-url="{{route( 'recycle.destroy',$v)}}"
