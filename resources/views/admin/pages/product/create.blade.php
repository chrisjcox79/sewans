                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" class="form-control" name="product_name" type="number" autocomplete="off"
                                               value="{{ old('product_name') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" class="form-control" name="sku_code" type="text" autocomplete="off"
                                               value="{{ old('sku_code') }}">
