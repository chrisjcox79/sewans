                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" class="form-control" name="cost_price" type="number" autocomplete="off"
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <select class="form-control" id="brand" name="brands_id">
                                        ...
                                        @foreach ($brands as $v)
                                            <option value="{{ $v->id }}" {{$v->id == $data->brands_id ?'selected':''}}>{{ $v->brand_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="cate_1">
                                        ...
                                        @foreach ($category_one as $v)
                                            <option value="{{ $v->id }}" {{$v->id == $data->brands_id ?'selected':''}}>{{ $v->cate_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="is_recommend" {{$data->is_recommend==1 ?'checked':''}}
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="is_recommend"
                                                   id="is_recommend1" value="0" {{$data->is_recommend==0 ?'checked':''}}>
                                            否
                                        </label>
                                    </div>
                            ...
                            <div class="col-3">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="is_hot" id="is_hot" {{$data->is_hot==1 ?'checked':''}}
                                                   value="1">
                                            是
                                        </label>
                                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="file" id="product_thumb" class="border" name="product_thumb"
                               data-allowed-file-extensions="gif png jpg jpeg svg" data-max-file-size-preview="5M" data-default-file="{{ltrim($data->product_thumb,'?')  }}" />
                    </div>
                </div>
            </div>
        </div>
        ...
        $(function () {
            ...
            (function( $ ){
                ...
                $(function() {
                    ...
                    updateTotalProgress();
                    let picList = ['https://sewans-upload.oss-cn-shanghai.aliyuncs.com/product/af698b28302109ede90ea1100f97bf83.jpg?x-oss-process=image/resize,m_fixed,h_625,w_485'];
