        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('types.update',$type['id']) }}" method="POST" id="attr-form">
                        @csrf
                        <div class="form-group">
                            <label>商品属性</label>
                            <input id="attribute_value" class="form-control " name="attr[0][name]"
                                   type="text" placeholder="如:尺寸,颜色" value="{{ $type['type_name'] }}">
                        </div>
                        <div class="" id="item-row-table">
                                @foreach($type['attributes'] as $k=>$attribute)
                                    ...
                                    <div class="row attr-table">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="attribute_value" class="form-control " name="attr[{{$k}}][name]"
                                                       type="text" placeholder="如:尺寸,颜色" value="{{ $attribute['attribute_name'] }}">
                                            </div>

                                        </div>
                                        <div class="col-md-8 attr-row">
                                            @foreach($attribute['attr_values'] as $attr)
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="">
                                                            <input id="attribute_value" class="form-control "
                                                                   name="attr[{{$k}}][value][]" type="text" placeholder="如:蓝色"
                                                        ...
                                                        <div class="color-row">
                                                            <div class="d-flex align-items-center">
                                                                <input type="color" class="form-control"
                                                                       name="attr[{{$k}}][color][]"  value="{{ $attr["attribute_color_value"] }}"/>
                                                                {{-- <i
...
`);
            ...
            $(document).on('click', ".add-attr-row-item", function() {
                ...
                var $input = $(this).closest('.item-row').find('.attr-table').children('.attr-row').children('.attr-row-item:last-child').clone(true);
                $input.find(':text').val('');
                $input.val('');
